...
import (
	...
	"github.com/khulnasoft-labs/sarif"
)
...
func main() {
	...
	report.RegisterTool(sarif.ToolComponent{
		...
		DownloadURI:     "https://github.com/khulnasoft-labs/xxx",
	...
	location := sarif.Location{
		...
		PhysicalLocation: sarif.PhysicalLocation{
			...
			ArtifactLocation: sarif.ArtifactLocation{
				Uri: "https://khulnasoft.com/api/user=admin'",
				Description: &sarif.Message{
					Text: "https://khulnasoft.com/api/user=admin'",
				},
			},
		},
	}
